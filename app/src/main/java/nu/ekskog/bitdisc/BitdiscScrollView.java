...
public class BitdiscScrollView extends ScrollView {
    ...
    private void startStickingView(View viewThatShouldStick) {
        int c = getResources().getColor(android.R.color.background_dark);
        viewThatShouldStick.setBackgroundColor(c);
    ...
    private void stopStickingCurrentlyStickingView() {
        int c = getResources().getColor(android.R.color.transparent);
        currentlyStickingView.setBackgroundColor(c);
        if(getStringTagForView(currentlyStickingView).contains(FLAG_HASTRANSPARANCY)){
            showView(currentlyStickingView);
        }
